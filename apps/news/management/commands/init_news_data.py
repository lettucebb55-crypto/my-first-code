        ...
        news_data = [
            {
                'category': category1,
                'title': '保定三日游超详细攻略（必看）',
                'abstract': '本文为您规划了保定三日游的最佳路线，涵盖了直隶总督署、保定植物园、古莲花池等必游景点，包含详细的行程安排、交通指南、美食推荐和住宿建议。',
                'content': '''# 保定三日游超详细攻略
...
保定植物园是保定市重要的城市生态公园，春季花海和秋季彩叶都很适合拍照与休闲。
...
- 保定植物园：可选择景区周边酒店，出行便捷''',
            ...
            {
                'category': category2,
                'title': '保定植物园景区国庆期间接待游客超10万人次',
                'abstract': '据报道，国庆黄金周期间，保定市各大景区迎来旅游高峰，其中保定植物园景区接待游客超过10万人次，创历史新高。',
                'content': '''# 保定植物园景区国庆期间接待游客超10万人次

国庆黄金周期间，保定市各大景区迎来旅游高峰。据保定市旅游局统计，保定植物园景区在国庆期间共接待游客超过10万人次，创历史新高。

## 游客增长情况

今年国庆期间，保定植物园景区游客量较去年同期增长30%，主要得益于：
1. 景区基础设施的完善
2. 宣传力度的加大
3. 旅游服务的提升
...
在保护历史文化的同时，保定也在积极发展现代旅游业，让更多人了解保定的历史文化魅力。''',
            ...
            {
                'category': category1,
                'title': '保定植物园最佳游览时间及游玩攻略',
                'abstract': '保定植物园什么时候去最好？本文为您详细介绍保定植物园的最佳游览时间、游玩路线和注意事项。',
                'content': '''# 保定植物园最佳游览时间及游玩攻略

## 最佳旅游时间

保定植物园的最佳游览时间是**4-6月与9-10月**，此时：
- 花卉景观丰富，拍照效果更好
- 温度舒适，适合步行慢游
- 园区活动较多，亲子体验更丰富
...
2. **防晒**：园区步行时间较长，建议备遮阳帽和饮水
3. **安全**：按园区导览路线游览，照看好儿童
4. **环保**：不要乱扔垃圾，保护环境
